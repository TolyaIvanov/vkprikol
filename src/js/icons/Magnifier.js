...
function Magnifier({className, fill}) {
	return (
		<Fragment>
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.1 26.1" xmlnsXlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 26.1 26.1">
